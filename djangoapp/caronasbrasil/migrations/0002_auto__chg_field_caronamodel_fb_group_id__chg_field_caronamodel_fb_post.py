...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'CaronaModel.fb_post_id'
        db.alter_column(u'caronasbrasil_caronamodel', 'fb_post_id', self.gf('django.db.models.fields.CharField')(max_length=30))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'CaronaModel.fb_group_id'
        db.alter_column(u'caronasbrasil_caronamodel', 'fb_group_id', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'CaronaModel.fb_post_id'
        db.alter_column(u'caronasbrasil_caronamodel', 'fb_post_id', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'CaronaGroupModel.fb_group_id'
        db.alter_column(u'caronasbrasil_caronagroupmodel', 'fb_group_id', self.gf('django.db.models.fields.IntegerField')())
    ...
    models = {
        u'caronasbrasil.caronagroupmodel': {
            ...
            'fb_group_id': ('django.db.models.fields.CharField', [], {'max_length': '30'}),
