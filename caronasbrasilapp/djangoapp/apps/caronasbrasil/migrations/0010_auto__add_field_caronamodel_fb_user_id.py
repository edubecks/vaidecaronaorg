...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CaronaModel.fb_user_id'
        db.add_column(u'caronasbrasil_caronamodel', 'fb_user_id',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=20),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CaronaModel.fb_user_id'
        db.delete_column(u'caronasbrasil_caronamodel', 'fb_user_id')
