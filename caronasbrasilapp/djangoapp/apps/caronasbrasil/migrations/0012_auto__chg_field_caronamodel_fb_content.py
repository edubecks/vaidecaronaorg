...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'CaronaModel.fb_content'
        db.alter_column(u'caronasbrasil_caronamodel', 'fb_content', self.gf('django.db.models.fields.CharField')(max_length=1001))

    def backwards(self, orm):

        # Changing field 'CaronaModel.fb_content'
        db.alter_column(u'caronasbrasil_caronamodel', 'fb_content', self.gf('django.db.models.fields.CharField')(max_length=1000))
    ...
    models = {
        ...
        u'caronasbrasil.caronamodel': {
            ...
            'fb_content': ('django.db.models.fields.CharField', [], {'max_length': '1001'}),
